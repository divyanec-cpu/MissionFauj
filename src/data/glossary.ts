...
export const GLOSSARY_GROUPS: GlossaryGroup[] = [
  {
    ...
    terms: [
      ...
      { abbr: 'ACC', full: 'Army Cadet College — serving Army soldiers commissioned as officers' },
      { abbr: 'CW', full: 'Cadet Entry Scheme (Navy) — serving sailors commissioned as officers' },
